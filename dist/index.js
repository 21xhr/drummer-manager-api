...
const gamemasterRoutes_1 = __importDefault(require("./routes/gamemasterRoutes"));
...
const consoleLogger_1 = require("./eventSubscribers/consoleLogger");
const notificationService_1 = require("./eventSubscribers/notificationService");
// --- Server Setup ---
...
app.use('/api/v1/clock', clockRoutes_1.default);
app.use('/api/gamemaster', gamemasterRoutes_1.default);
app.use('/api/v1/stream', streamRoutes_1.default);
...
async function startServer() {
    try {
        ...
        await (0, streamService_1.initializeStreamState)();
        // Start the continuous session scheduler
        (0, scheduler_1.startChallengeScheduler)();
        // Initialize Event Subscribers
        (0, consoleLogger_1.initializeConsoleSubscribers)();
        (0, notificationService_1.initializeNotificationService)();
    }
    catch (error) {
